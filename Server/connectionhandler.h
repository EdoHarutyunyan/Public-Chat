...
private:
    ...
    void readSignUpRequest(QTcpSocket *socket);
    void readAddContactRequest(QTcpSocket *socket);
    void readMessage(QTcpSocket *socket);
    void writeAuthAnswer(QTcpSocket *socket, bool answer);
    void writeSignUpAnswer(QTcpSocket *socket, bool answer);
    void writeAddContactAnswer(QTcpSocket *socket);
